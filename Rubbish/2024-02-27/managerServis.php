...
if($_POST){
        ...
        require_once("content_tools/ultramsg.class.php");
       ...
       /* $to=$phone; 
        ...
        function laravel1_body($phone,$message,$id){
            $params=array(
                ...
                curl_setopt_array($curl, array(
                  CURLOPT_URL => "https://api.ultramsg.com/instance79397/messages/chat",
        ...
        function laravel1_img($phone,$id){
           
            $numeroAleatorio = rand(1, 3);
            $arrayModal2 = ['https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiZTZrnY2A4K0McC6bFqIwChjlYcFsBVjaL-4gVzl87zajaE32egRRBKmIWQ4sfxu3j3MWpvNyXIfbyGpSjw9VS1rFwxMmqREpt0ka-uVimP5wF7o7143ir50K5_AKyJ5ZWvTXKg7_1kh61reKojmQiX6Lr2QkmM6r_1GFPXb2HRGFlYH-SSi5UUEfqOc5S/s16000/flyer-modal-2-1.jpg',
            ...
            $arrayModal3 =['https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg092QZpO6nk2lCpzY4OoufMEqQ4t-4Cd6a2ZzPY1SKNRb40qJeU3dlHEdaFtnZTTZUbX1kbn3TXZ9Z4eVzgJTflVTsQBqZbd2yFnHUTHhtXGzLOm3G7AR5bQVVoGEU8dLJLxSBgLeuFv1YEzy-wtCy2QCUyAoSWRL4Ckc5a9b9XlJ62WmAU_zJG4z4e-Om/s16000/flyer-modal-3-1.jpg',
            ...
            if($id==2){
                $url = $arrayModal2[$numeroAleatorio-1];
            }else if($id==3){
                $url = $arrayModal3[$numeroAleatorio-1];
            }
